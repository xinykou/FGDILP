...
name=selfdiagnosis-subtoxicity_vector-llama2-chat-ContextLevel
...
python ./Baseline/run_evaluation_sim_and_fl.py \
       ...
       --current_path /media/data/2/yx/model_toxic/my_project/results/ContextLevelToxicity/selfdiagnosis-subtoxicity_vector-llama2-chat-ContextLevel/selfdiagnosis-subtoxicity_vector-llama2-chat-ContextLevel__mergingtopk50_normmass_dis-max__.jsonl \
       --batch_size 128
