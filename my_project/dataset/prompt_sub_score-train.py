...
def main():
    prompts_file = "/media/data/2/yx/model_toxic/my_project/results/vector_p_muti_gen/toxic_filters_gen.jsonl"
    tags_file = "/media/data/2/yx/model_toxic/my_project/results/vector_p_muti_gen/toxic_filters_gen_tags.jsonl"
    created_li = []
