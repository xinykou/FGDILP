...
api_key = "AIzaSyDThdnUO0HtR7WcbLrkKXf3aMG2uNPEKR4"
...
def main():
    ...
    tags_file = "/media/data/2/yx/model_toxic/my_project/results/vector_p_muti_select_gen/nontoxic_filters_gen_tags-partI.jsonl"
    created_li = []
