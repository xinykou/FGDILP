...
name=sd-llama2-ContextLevel
config_path=./Baseline/configs/sd/${name}.py
...
python ./Baseline/run_evaluation_sim_and_fl.py \
       ...
       --current_path /media/data/2/yx/model_toxic/Baseline/results/ContextLevelToxicity/sd-llama2-ContextLevel/sd-llama2-ContextLevel.jsonl \
       --batch_size 128
