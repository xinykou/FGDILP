...
python ./Baseline/run_evaluation_sim_and_fl.py \
       ...
       --current_path /media/data/2/yx/model_toxic/Baseline/results/ContextLevelToxicity/sd-vicuna-ContextLevel/sd-vicuna-ContextLevel.jsonl \
       --batch_size 128
