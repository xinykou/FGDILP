...
python ./Baseline/run_evaluation_sim_and_fl.py \
       ...
       --current_path /media/data/2/yx/model_toxic/Baseline/results/ContextLevelToxicity/goodtriever-llama2-chat-ContextLevel/goodtriever-llama2-chat-ContextLevel.jsonl \
       --batch_size 128
