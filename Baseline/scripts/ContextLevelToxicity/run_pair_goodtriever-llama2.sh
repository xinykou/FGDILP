...
neg_name=llama2_toxic
pos_name=llama2_nontoxic
name=goodtriever-llama2-ContextLevel
...
#  --model_name /media/data/1/yx/data/model_cache/llama2-7b \
#  --batch_size 1 \
#  --knn True \
#  --knn_temp 100 \
#  --max_new_tokens 30 \
...
python ./Baseline/run_evaluation_sim_and_fl.py \
       ...
       --current_path /media/data/2/yx/model_toxic/Baseline/results/ContextLevelToxicity/goodtriever-llama2-ContextLevel/goodtriever-llama2-ContextLevel.jsonl \
       --batch_size 128
