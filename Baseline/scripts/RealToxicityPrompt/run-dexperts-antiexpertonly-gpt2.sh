...
#    --config configs/dexperts/dexperts-antiexpertonly-gpt2-l_rtp-test-toxic-2k.py \
...
#       --current_path /media/data/2/yx/model_toxic/Baseline/results/RealToxicityPrompt/dexperts-antiexpertonly-gpt2-l_rtp-test-${data_type}-2k.jsonl \
#       --batch_size 128
#
#python ./Baseline/run_evaluation_sim_and_fl.py \
#       --eval_type sim \
...
data_type="nontoxic"
#python /media/data/2/yx/model_toxic/Baseline/run_generation-gpt2.py \
#    --config configs/dexperts/dexperts-antiexpertonly-gpt2-l_rtp-test-nontoxic-8k.py \
#    --fn /media/data/2/yx/model_toxic/Baseline/results/RealToxicityPrompt
#
#
#python /media/data/2/yx/model_toxic/Baseline/run_evaluation.py \
...
python ./Baseline/run_evaluation_sim_and_fl.py \
       --eval_type fl \
       --org_path /media/data/2/yx/model_toxic/Baseline/results/RealToxicityPrompt/gpt2-RealToxicityPrompt-${data_type}.jsonl \
       --current_path /media/data/2/yx/model_toxic/Baseline/results/RealToxicityPrompt/dexperts-antiexpertonly-gpt2-l_rtp-test-${data_type}-8k.jsonl \
       --batch_size 128
