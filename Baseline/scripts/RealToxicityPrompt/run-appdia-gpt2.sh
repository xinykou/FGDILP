...
#    --config ./Baseline/configs/style_transfer/appdia.py \
#    --is_toxictity \
#    --transfer_name appdia \
#    --fn ./Baseline/results/RealToxicityPrompt
#
#
#python /media/data/2/yx/model_toxic/Baseline/run_evaluation.py \
#    --config ./Baseline/configs/style_transfer/appdia-${data_type}.py \
...
#       --current_path ./Baseline/results/RealToxicityPrompt/appdia-${data_type}.jsonl \
#       --batch_size 128
#
#python ./Baseline/run_evaluation_sim_and_fl.py \
#       --eval_type sim \
