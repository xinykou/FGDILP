...
#       --current_path /media/data/2/yx/model_toxic/Baseline/results/RealToxicityPrompt/innerdetox-gpt2-l-ne0.4-nse0.6-renorm_np0-pp0_rtp-test-${data_type}-2k.jsonl \
#       --batch_size 128
#
#python ./Baseline/run_evaluation_sim_and_fl.py \
#       --eval_type sim \
...
python ./Baseline/run_evaluation_sim_and_fl.py \
       --eval_type fl \
       --org_path /media/data/2/yx/model_toxic/Baseline/results/RealToxicityPrompt/gpt2-RealToxicityPrompt-${data_type}.jsonl \
       --current_path /media/data/2/yx/model_toxic/Baseline/results/RealToxicityPrompt/innerdetox-gpt2-l-ne0.4-nse0.6-renorm_np0-pp0_rtp-test-${data_type}-8k.jsonl \
       --batch_size 128
