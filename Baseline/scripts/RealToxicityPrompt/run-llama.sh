...
#    --config configs/others/llama-ne0.4-nse0.6-renorm_np0-pp0_rtp-test-toxic-2k.py
#
#
...
#python /media/data/2/yx/model_toxic/Baseline/run_generation-llama.py \
#    --config configs/others/llama-ne0.4-nse0.6-renorm_np0-pp0_rtp-test-nontoxic-8k.py
#
#
#python /media/data/2/yx/model_toxic/Baseline/run_evaluation.py \
#    --config configs/others/llama-ne0.4-nse0.6-renorm_np0-pp0_rtp-test-nontoxic-8k.py \
